...
@section('title', 'Crear Conocimiento | TIC Educativa')
...
@section('content_header')
	...
	<h1>
		Conocimientos
		<small>Nuevo Conocimeinto</small>
	</h1>
	<ol class="breadcrumb">
		...
		<li class="active">Nuevo Conocimiento</li>
	</ol>
	...
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="box box-primary">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<form role="form" method="POST" action="{{ route('administrator.conocimiento.store') }}" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="box-body">
						<div class="form-group">
							<label for="titulo">Nombre de Conocimiento</label>
							<input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ingrese el nombre del conocimiento adquirido">
						</div>
						<div class="form-group">
							<label for="descripcion">Descripción</label>
							<textarea class="form-control" rows="3" id="descripcion" name="descripcion" placeholder="Describe el conocimiento adquirido"></textarea>
						</div>
						<div class="form-group">
